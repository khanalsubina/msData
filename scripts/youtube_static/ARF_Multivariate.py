...
def main():
    ...
    parser.add_argument("--dataset", default="youtube_static.csv", help="CSV file inside data/filtered/")
    ...
    results_dir = (project_root/ "notebooks"/ "results"/ "metrics"/ "youtube_static")
    ...
    metrics_file = results_dir / f"arf_multi_metrics.csv"
    ...
    summary_file = results_dir / f"arf_multi_summary.csv"
